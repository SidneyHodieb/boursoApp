<template>
  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        ...
        <v-slide-x-transition>
          <h2 class="app-title text--primary">BOURSORAMA</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      ></nav-menu-link>
       <nav-menu-link title="Tous les rapports" :to="{ name: 'file-explorer' }" :icon="icons.mdiFolderOpen"></nav-menu-link>
      ...
      <nav-menu-section-title title="Fonctions Admin"></nav-menu-section-title>
      <nav-menu-link title="Editeur SQL" :to="{ name: 'typography' }" :icon="icons.mdiDatabaseSearch"></nav-menu-link>
